...
const Table = () => {
    ...
    ? Feedback.filter((item) =>
        item.stationID.StationName.toLowerCase().includes(searchTerm.toLowerCase())
      )
    : [];
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" className="px-4 py-3">After How much time you are heard in Police Station?</th>
                <th scope="col" className="px-4 py-3">How would you describe your overall experience when communicating with the police at the station?</th>
                <th scope="col" className="px-4 py-3">How would you rate the overall cleanliness and maintenance of the police station premises?</th>
            
                <th scope="col" className="px-4 py-3">Do you think the police effectively keep residents informed about safety issues and initiatives?</th>
                <th scope="col" className="px-4 py-3">How would you rate the level of trust you have in the police based on your experience?</th>
            ...
            <tbody>
              {Feedback?.map((feedback)=>(
                ...
                <td className="px-4 py-3 text-black "><TimeAgo date={feedback?.feedbackTime
}/></td>
           {feedback.questions.map((question)=>(
                <td className="px-4 py-3 text-black">{question.answer}</td>
           ))}
