...
const Table = () => {
  ...
  const filteredFeedback = Feedback
    ? Feedback.filter((item) =>
        item.stationID.StationName.toLowerCase().includes(
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <tr>
                    ...
                    <th scope="col" className="px-4 py-3">
                      How would you describe your overall experience when
                      communicating with the police at the station?
                    </th>
                    <th scope="col" className="px-4 py-3">
                      How would you rate the overall cleanliness and maintenance
                      of the police station premises?
                    </th>

                    <th scope="col" className="px-4 py-3">
                      Do you think the police effectively keep residents
                      informed about safety issues and initiatives?
                    </th>
                    <th scope="col" className="px-4 py-3">
                      How would you rate the level of trust you have in the
                      police based on your experience?
                    </th>
                    <th scope="col" className="px-4 py-3">
